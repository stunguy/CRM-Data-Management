...
st.title("Chat with PDF - Clean Version 🤖")

# Configuration
DB_FAISS_PATH = 'vectorstore/db_faiss'
FILE_LIST_PATH = 'vectorstore/file_list.json'
PDF_STORAGE_PATH = 'vectorstore/pdfs'
client = OpenAI(api_key='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')
